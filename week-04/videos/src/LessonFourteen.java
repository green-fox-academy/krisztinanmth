public class LessonFourteen{
  ...
  public static void main(String[] args){
    ...
    System.out.print(genericAnimal.getName() + ", ");
    System.out.print(genericAnimal.favFood);
    System.out.println();
    ...
    System.out.print(morris.getName() + ", ");
    System.out.print(morris.favFood + ", ");
    System.out.print(morris.favToy);
    System.out.println();
  ...
  public static void acceptAnimal(Animal randAnimal){
    ...
    System.out.print(randAnimal.getName() + ", ");
    System.out.print(randAnimal.favFood);
    System.out.println();
